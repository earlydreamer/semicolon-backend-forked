...
- 앱 공통 env:
  ...
  - Secrets `DB_USERNAME`, `DB_PASSWORD`, `JWT_ACCESS_SECRET`, `JWT_REFRESH_SECRET`, `CRYPTO_KEY`, `INTERNAL_SERVICE_TOKEN`, `INIT_ADMIN_PASSWORD`, `OPENAI_API_KEY`, `SYSTEM_DEPOSIT_PASSWORD`, `TOSS_API_SECRET_KEY`, `OBJECT_STORAGE_ACCESS_KEY`, `OBJECT_STORAGE_SECRET_KEY`, `GOOGLE_OAUTH_CLIENT_SECRET`, `GRAFANA_ADMIN_PASSWORD`, `SLACK_WEBHOOK_URL_SETTLEMENT`, `SLACK_WEBHOOK_URL_GRAFANA`, `EMAIL_PASSWORD`
