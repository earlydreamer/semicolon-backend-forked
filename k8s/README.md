...
- 앱 공통 env: `DB_USERNAME`, `DB_PASSWORD`, `JWT_ACCESS_SECRET`, `JWT_REFRESH_SECRET`, `CRYPTO_KEY`, `INTERNAL_SERVICE_TOKEN`, `OPENAI_API_KEY`, `SYSTEM_DEPOSIT_PASSWORD`, `TOSS_API_SECRET_KEY`, `OBJECT_STORAGE_ACCESS_KEY`, `OBJECT_STORAGE_SECRET_KEY`, `OBJECT_STORAGE_REGION`, `OBJECT_STORAGE_BUCKET`, `OBJECT_STORAGE_ENDPOINT`, `OBJECT_STORAGE_PATH_STYLE_ACCESS_ENABLED`, `GOOGLE_OAUTH_CLIENT_ID`, `GOOGLE_OAUTH_CLIENT_SECRET`, `GRAFANA_ADMIN_USER`, `GRAFANA_ADMIN_PASSWORD`, `SLACK_WEBHOOK_URL_SETTLEMENT`, `SLACK_WEBHOOK_URL_GRAFANA`
