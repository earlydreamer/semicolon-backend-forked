...
import dukku.product.boundedContext.product.app.support.SellerReviewMapper;
...
import dukku.common.shared.product.exception.ReviewAlreadyExistsException;
...
public class CreateSellerReviewUseCase {
    ...
    public SellerReviewResponse execute(UUID buyerUuid, SellerReviewCreateRequest request) {
        ...
        reviewStatsRedisSupport.incrementReviewCount(saved.getSellerUuid());
        reviewStatsRedisSupport.addRating(saved.getSellerUuid(), saved.getRating());
